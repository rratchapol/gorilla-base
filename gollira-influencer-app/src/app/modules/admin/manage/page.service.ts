...
import { Customer, InventoryBrand, InventoryCategory, InventoryPagination, InventoryProduct, InventoryTag, InventoryVendor, PageEmployee } from './page.types';
// import { environment } from 'environments/environment.development';
// import { DataTablesResponse } from 'app/modules/shared/datatable.types';
...
export class Service
{
    ...
    // {
    //     return this._httpClient.post<Customer>(environment.baseURL + "/api/item_add", data).pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    //     );
    // }

    // uploadimages(data): Observable<Customer>
    // {
    //     return this._httpClient.post<Customer>(environment.baseURL + "/api/upload_images", data).pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // update(data:any , id:any): Observable<Customer>
    // {
    //     return this._httpClient.put<Customer>(environment.baseURL + "/api/update2_item/" + id, data).pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.get<any>(environment.baseURL + "/api/positions").pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.get<any>(environment.baseURL + "/api/get_item_type").pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.get<any>(environment.baseURL + "/api/get_location").pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.get<any>(environment.baseURL + "/api/get_unit").pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.get<any>(environment.baseURL + "/api/get_vendor").pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    //     sortBy: 'asc' | 'desc' | '' = 'asc',
    //     search: string = ''):
    //     Observable<{ pagination: PageEmployee; products: InventoryProduct[] }>
    // {
    //     return this._httpClient.get<{ pagination: PageEmployee; products: InventoryProduct[] }>(environment.baseURL + '/api/employees/page?',
    //     {
    //         params: {
    //             page: 0 + page,
    //             perPage: '' + perPage,
    ...
    // {
    //     return this._httpClient.get<any>("assets/data-mockup/user.json").pipe(
    //         tap((result) =>
    //         {
    ...
    //       .get<any>("assets/data-mockup/user.json")
    //       .pipe(
    //         map((station: any) => {
    //           return station;
    //         }));
    ...
    //     return this._httpClient.post(environment.baseURL + '/api/item_page', dataTablesParameters).pipe(
    ...
    //   deleteCustomer(id: any): Observable<DataTablesResponse> {
    //     return this._httpClient.delete(environment.baseURL + `/api/item/${id}`).pipe(
    //       switchMap((response: any) => {
    //         return of(response);
    //       })
    //     ); 
    ...
    //     getCustomerId(id: any): Observable<DataTablesResponse> {
    //         return this._httpClient.get(environment.baseURL + `/api/item/${id}`).pipe(
    //           switchMap((response: any) => {
    //             return of(response);
    //           })
    //         ); 
