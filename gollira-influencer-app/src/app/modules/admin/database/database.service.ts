...
import { Employee, InventoryBrand, InventoryCategory, InventoryPagination, InventoryProduct, InventoryTag, InventoryVendor, PageEmployee } from './database.types';
...
export class DatabaseService
{
    ...
    // {
    //     return this._httpClient.post<Employee>(environment.baseURL + "/api/employees", data).pipe(
    //         tap((result) =>
    //         {
    ...
    // {
    //     return this._httpClient.put<Employee>(environment.baseURL + "/api/employees/" + id, data).pipe(
    //         tap((result) =>
    //         {
    //             this._employee.next(result);
    //         }),
