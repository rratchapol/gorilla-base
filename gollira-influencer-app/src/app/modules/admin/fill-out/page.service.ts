...
export class Service
{
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.baseURL + '/api/influencer_page', dataTablesParameters).pipe(
    ...
    {
        return this._httpClient.post<Customer>(environment.baseURL + "/api/influencer", data).pipe(
            tap((result) =>
            {
    ...
    // create(data:any): Observable<Customer>
    // {
    //     return this._httpClient.post<Customer>(environment.baseURL + "/api/station", data).pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.put<Customer>(environment.baseURL + "/api/station/" + id, data).pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.get<any>(environment.baseURL + "/api/station").pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // {
    //     return this._httpClient.post<Customer>(environment.baseURL + "/api/customer", data).pipe(
    //         tap((result) =>
    //         {
    //             this._customer.next(result);
    //         }),
    ...
    // getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    //     return this._httpClient.post(environment.baseURL + '/api/station_page', dataTablesParameters).pipe(
    //       switchMap((response: any) => {
    //         return of(response);
    //       })
    //     );
    ...
    //     return this._httpClient.get(environment.baseURL + `/api/station/${id}`).pipe(
    //       switchMap((response: any) => {
    //         return of(response);
    //       })
    //     ); 
    ...
    //     return this._httpClient.delete(environment.baseURL + `/api/station/${id}`).pipe(
    //       switchMap((response: any) => {
    //         return of(response);
    //       })
    //     ); 
    //     }
        ...
        // getstationID(id: any): Observable<DataTablesResponse> {
        //     return this._httpClient.get(environment.baseURL + `/api/station/${id}`).pipe(
        //       switchMap((response: any) => {
        //         return of(response);
        //       })
        ...
        {
            return this._httpClient.get<any>(environment.baseurl + "/api/get_province").pipe(
                tap((result) =>
                {
                    this._customer.next(result);
                }),
