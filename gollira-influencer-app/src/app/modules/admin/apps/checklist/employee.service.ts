...
import { Employee, InventoryBrand, InventoryCategory, InventoryPagination, InventoryProduct, InventoryTag, InventoryVendor, PageEmployee } from './employee.types';
...
export class EmployeeService
{
    ...
    //     return this._httpClient.post(environment.baseURL + '/api/position_page', dataTablesParameters).pipe(
