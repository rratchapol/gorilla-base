...
export const appRoutes: Route[] = [
    ...
    // Auth routes for guests
    {
        ...
        children: [
            ...
            { path: 'sign-inmember', loadChildren: () => import('app/modules/auth/sign-inmember/sign-in.routes') },
            { path: 'sign-incustomer', loadChildren: () => import('app/modules/auth/sign-incustomer/sign-in.routes') },
            { path: 'sign-inline', loadChildren: () => import('app/modules/auth/sign-inline/sign-in.routes') },
    ...
    // Auth routes for authenticated users
    {
        ...
        children: [
            ...
            { path: 'dialog', loadChildren: () => import('app/modules/auth/dialog/dialog.routes') },
...

    {
        ...
        children: [
            { path: 'liff', loadChildren: () => import('app/modules/liff/line.routes') },
        ]
    },
    ...
    // Admin routes
    {
        ...
        children: [
            { path: 'admin', loadChildren: () => import('app/modules/admin/admin/admin.routes') },
            { path: 'driver', loadChildren: () => import('app/modules/admin/driver/driver.routes') },
            { path: 'driver-detail', loadChildren: () => import('app/modules/admin/driver/driver-detail/driver-detail.routes') },
            { path: 'verification', loadChildren: () => import('app/modules/admin/verification/verification.routes') },
            { path: 'account', loadChildren: () => import('app/modules/admin/account/account.routes') },
            { path: 'matching', loadChildren: () => import('app/modules/admin/matching/matching.routes') },
            { path: 'account', loadChildren: () => import('app/modules/admin/account/account.routes') },
            { path: 'fill-out', loadChildren: () => import('app/modules/admin/fill-out/fill-out.routes') },
            { path: 'employee', loadChildren: () => import('app/modules/admin/employee/employee.routes') },
            { path: 'database', loadChildren: () => import('app/modules/admin/database/database.routes') },
            { path: 'timeline', loadChildren: () => import('app/modules/admin/timeline/timeline.routes') },
            { path: 'item', loadChildren: () => import('app/modules/admin/item/item.routes') },
            { path: 'tasks', loadChildren: () => import('app/modules/admin/tasks/tasks.routes') },
            { path: 'manage', loadChildren: () => import('app/modules/admin/manage/page.routes') },
            { path: 'select', loadChildren: () => import('app/modules/admin/select/select.routes') },
            { path: 'select1', loadChildren: () => import('app/modules/admin/select1/select.routes') },
            { path: 'select2', loadChildren: () => import('app/modules/admin/select2/select.routes') },
            ...
            {
                path: 'tasks', children: [
                    { path: 'product', loadChildren: () => import('app/modules/admin/tasks/product/product.routes') },
            ...
            // Dashboards
            {
                path: 'dashboards', children: [
                    ...
                    { path: 'projectt', loadChildren: () => import('app/modules/admin/dashboards/projectt/project.routes') },
                    { path: 'projecttt', loadChildren: () => import('app/modules/admin/dashboards/projecttt/project.routes') },
            ...
            // Apps
            {
                path: 'apps', children: [
                    ...
                    { path: 'checklist', loadChildren: () => import('app/modules/admin/apps/checklist/checklist.routes') },
